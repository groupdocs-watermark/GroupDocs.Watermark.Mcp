...
```bash
dnx GroupDocs.Watermark.Mcp@26.9.0 --yes
```
...
> `"GroupDocs.Watermark.Mcp@26.9.0"` in `args`. Pinning is recommended for
...
> `"GroupDocs.Watermark.Mcp@26.9.0"` to lock to a specific release.
